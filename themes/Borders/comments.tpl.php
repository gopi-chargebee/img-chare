...
<?   if($adding_comment){ ?>
			...
			<tr><td  colspan="2" align="left">
				 ...
				 <table >
				  ...
				  <tr><td colspan="2"><?p("ID_NAME");?><input name="p_name" size="25" disabled="disabled" value="<?=$comment_name?>"/>&nbsp;&nbsp;<?p("ID_EMAIL");?>
				  	<input name="p_email" size="30" disabled="disabled" value="<?=$comment_email?>"/><td></tr-->
